...
# libc++
if(LLOGCONF_USE_CUSTOM_LIBCXX)
  message(STATUS "Using custom libc++ located at ${LLOGCONF_USE_CUSTOM_LIBCXX}")

  add_compile_options(-nostdinc++ -isystem
                      "${LLOGCONF_USE_CUSTOM_LIBCXX}/include/c++/v1")

  add_link_options(
    -nostdlib++ "-L${LLOGCONF_USE_CUSTOM_LIBCXX}/lib/c++"
    -Wl,-rpath,"${LLOGCONF_USE_CUSTOM_LIBCXX}"/lib/c++ -lc++ -lc++abi)
else()
  message(STATUS "Using system libc++")

  add_compile_options(-stdlib=libc++)
  add_link_options(-stdlib=libc++)
endif(LLOGCONF_USE_CUSTOM_LIBCXX)
